...
pubDate: 2012-04-17T05:11:55.000Z
modifiedDate: 2021-05-25T03:57:23.000Z
author: "MAS"
categories: ["Web"]
tags: ["comments", "google"]
description: "This site recently passed a great milestone of having over 5,000 comments. I love the comments this site gets. I've gotten so many great ideas. Last year I added comments to my coffee site..."
commentCount: 7
---
...
2.  **CAPTCHA** - I hate [CAPTCHA](https://en.wikipedia.org/wiki/CAPTCHA). It often takes me multiple attempts to see those letters. There are far better ways to prevent SPAM that don't annoy the reader. Blogspot sites are most guilty of this. And [I hate Blogspot](/2008/03/i-hate-blogspot-too/). I find it ironic that Google engineers are geniuses when it comes to filtering email spam, but are blithering idiots when it comes to comment spam.
3.  **Force Me To login To Comment** - If I have to sign up for an account or use some authentication method that requires a form to fill out, I won't leave a comment. As bad as DISQUS was at filtering SPAM, they have a great interface for authenticating users. If you are logged into Twitter or Facebook, you can click a single button to be authenticated without filling out a form. Meanwhile, Google is completely stupid on this point. Even though I'm logged into GMAIL, YouTube and other Google services, I am forcing to log into their Blogger service to leave a comment on Blogspot accounts. There is also a bug that if you can't request to subscribe to comments until after you are authenticated. _\*BTW, I no longer report bugs to Google. I have a long history of them ignoring every bug request I've ever reported._
4.  **Censor My Comment** - Not "_holding for moderation_", but outright censored. I'm always respectful and never combative in the comments I leave. Once I figure out that a site censors comments, they are dead to me. _High Intensity Nation_ censored two of my comments. I am no longer a fan or supporter of that site.
...
9.  **Site Has Poor Typography** - I'm a sucker for a [clean user interface](http://me.veekun.com/). If you use small gray fonts on a white background, I won't comment. I can use the Readability plugin to make your site legible, but that plugin doesn't clean up the comments, just the content.
...
11.  **Doesn't Support Trackbacks** - I am more likely to link to and engage in the comments of a site that supports [Trackback links](https://en.wikipedia.org/wiki/Trackback). Sites like [FreeTheAnimal](https://freetheanimal.com/) and [PerfectHealthDiet](http://perfecthealthdiet.com/) have linked here and me to them. We all honor trackback links. Blogger and Blogspot sites do not support trackbacks. This one isn't a deal-breaker, but a nice to have.
...
### chuck
*April 17 at 2012 at 12:48 AM*

here is a reason, author does not get involved in comments.  nothing worse than providing feedback or adulation with no response.

---

### MAS
*April 17 at 2012 at 1:12 AM*

@Chuck - That is sort of like the second half of my #6. To me that provides the appearance that the comments aren't being maintained. Something else I could also add to the list is when comments go into an endless "hold for moderation" state.

---

### Jim
*April 17 at 2012 at 2:00 AM*

A form of number 10 is the reason I typically don't comment here.  I'll typically enjoy and learn from the posts, but I won't feel any particular need or motivation to comment.  I'm sometimes surprised at the low number of comments on some posts here, but I think others may share my sentiment.  So, please continue on, as we read and enjoy in silence.  
:-)

---

### MAS
*April 17 at 2012 at 2:25 AM*
...
### Beth@WeightMaven
*November 18 at 2013 at 10:43 PM*
...
### MAS
*November 18 at 2013 at 10:49 PM*

@Beth - I have a really good SPAM filter setup. Akismet + Wordpress Hashcash + NoSpamNX. That combo works better than anything I've ever used before. It is better than GMAIL Spam filtering.
