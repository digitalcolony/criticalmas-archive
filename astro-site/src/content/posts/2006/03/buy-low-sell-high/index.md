...
My short answer is _not right now_. My polite answer is that _I'm still deciding if downtown living is right for me_. Do you _really_ want to hear the long answer? What is going to happen to downtown San Diego? Here are a few stats:
...
From [Do UC What Downtown Sees?](https://voiceofsandiego.org/2006/03/23/do-uc-what-downtown-sees-3/):
...
From _NCTimes Unsold home inventory builds_:
...
Let's do the math. High Supply + Huge Future Supply + Falling Demand + Low Owner Occupancy Rate + Investors Leaving + Rising Interest Rates = Price Correction.
