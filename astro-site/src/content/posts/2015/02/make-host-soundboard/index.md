...
One of the projects I work on is the audio archive site for the late Miami radio host [Neil Rogers](https://neilrogers.org/), which I discussed in the post [My Tribute to Radio's Neil Rogers](/2014/01/tribute-radios-neil-rogers/).
...
I finally had enough with Soundboard.com, so I decided to code my own. In one weekend, I taught myself just enough PHP, HTML5 and JQuery to not only create a worthy replacement, but a soundboard that is superior to theirs. _I did get some help from my pal [Joe Crawford](https://artlung.com/) on the JQuery. Thanks Joe!_
...
I am making the [code available on Github](https://github.com/digitalcolony/Simple-Soundboard) for anyone to use for free, no attribution necessary.
